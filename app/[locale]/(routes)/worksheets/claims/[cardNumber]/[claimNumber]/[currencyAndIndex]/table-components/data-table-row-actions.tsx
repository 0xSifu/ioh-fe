  ...
  return (
    <>
      ...
      <Sheet open={editOpen} onOpenChange={() => setEditOpen(false)}>
        <SheetContent>
          <SheetHeader>
            <SheetTitle>Detail Worksheet</SheetTitle>
            <SheetDescription></SheetDescription>
          </SheetHeader>
          {/* <DetailWorksheetForm initialData={project} openEdit={setEditOpen} /> */}
        </SheetContent>
      </Sheet>      
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-[260px]">
          <DropdownMenuItem
            onClick={() => router.push(`/worksheets/claims/${project.cardNumber}`)}
          >
